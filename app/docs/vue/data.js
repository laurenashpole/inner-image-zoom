...
export const DATA = {
    ...
    links: [
      {
        ...
        href: 'https://www.npmjs.com/package/vue-inner-image-zoom',
      },
      {
        title: 'Source code',
        label: 'Open repo on GitHub',
        icon: <FaCode size="1rem" />,
        href: 'https://github.com/laurenashpole/inner-image-zoom/tree/main/packages/vue',
      },
      {
        title: 'Changelog',
  ...
  quickstart: {
    ...
    items: [
      {
        label: 'Install',
        code: 'npm install vue-inner-image-zoom',
      },
      {
        label: 'Import',
        code: `import InnerImageZoom from 'vue-inner-image-zoom'`,
      },
      {
        label: 'Template',
  ...
  installation: {
    ...
    items: [
      ...
      {
        type: 'code',
        content: 'npm install vue-inner-image-zoom',
      },
      {
        type: 'heading',
        content: 'Yarn',
      ...
      {
        type: 'code',
        content: 'yarn add vue-inner-image-zoom',
      },
      {
        type: 'heading',
        content: 'TypeScript',
      },
      {
        ...
        content: (
          <>
            <Anchor
              href="https://github.com/laurenashpole/inner-image-zoom/blob/main/packages/vue/src/index.d.ts"
              underline="always"
            >
              Type declarations
            </Anchor>{' '}
            were added with version 3.0.0.
          </>
        ),
      },
    ],

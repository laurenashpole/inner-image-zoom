...
describe('react-inner-image-zoom', () => {
  ...
  const innerImageZoom = (props = {}) => {
    ...
    root.render(<InnerImageZoom src={DATA.src} {...props} />);
  };

  describe('mount', () => {
    describe('container', () => {
      it('renders a figure', async () => {
        innerImageZoom();
      ...
      it('renders a figure with a custom classname', async () => {
    ...
    describe('original image', () => {
      it('renders the original image', async () => {
        innerImageZoom();
      ...
      it('renders the original image with custom attributes if imgAttributes is set', async () => {
      ...
      it('combines image classes if imgAttributes contains className', async () => {
      ...
      it('ignores style transition properties in imgAttributes prop', async () => {
      ...
      it('renders the original image with source tags', async () => {
      ...
      it('only renders source tags that have srcSet set', async () => {
      ...
      it('renders a spacer if width, height, and hasSpacer are set', async () => {
      ...
      it('ignores hasSpacer if width or height are not set', async () => {
      ...
      it('hides the hint if hideHint is true', async () => {
  ...
  describe('zoom in', () => {
    describe('render', () => {
      it('renders the zoomed image on mouse enter', async () => {
        innerImageZoom({ imgAttributes: { alt: 'Test image' } });
      ...
      it('renders the zoomed image on render if zoomPreload is true', async () => {
